...
CREATE TABLE `t_deploy_unit` (
  ...
  `git_tag` varchar(45) NOT NULL COMMENT '部署的tag号',
  ...
  `docker_extras` varchar(1024) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='部署单元';

-- ----------------------------
-- Records of t_deploy_unit
-- ----------------------------
...
CREATE TABLE `t_deploy_unit_status` (
  ...
  `current_yml` varchar(45) DEFAULT NULL,
  `expired` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of t_deploy_unit_status
-- ----------------------------
...
CREATE TABLE `t_host` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL COMMENT '节点(宿主机)名称, 例如app-5',
  `set_id` int(11) NOT NULL,
  `ip` int(11) NOT NULL COMMENT '该节点IP信息',
...
-- ----------------------------
-- Records of t_operation_journal
-- ----------------------------
...
CREATE TABLE `t_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL COMMENT '环境集名称, 例如sandbox1, demo, onlineDemo, ',
  `env` varchar(8192) DEFAULT NULL COMMENT '环境变量',
  `created_at` datetime NOT NULL,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `remark` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='环境集信息表';
