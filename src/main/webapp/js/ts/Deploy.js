...
*/
    ...
    var ServiceFiles = /** @class */ (function () {
         ...
         * @param value
         */
        ServiceFiles.prototype.exportServiceFileAction = function (value) {
         ...
         * @param vaue
         */
        ServiceFiles.prototype.exportFileLinkUnitContext = function (value) {
         ...
         * 在表格中展开已经关联的部署单元
         */
        ServiceFiles.prototype.listLinkedUnits = function (units) {
        };
        return ServiceFiles;
    }());
